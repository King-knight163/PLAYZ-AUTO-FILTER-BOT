...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '@PLAYZ_HACKING'))
...
reqst_channel = environ.get('REQST_CHANNEL', 'https://t.me/botsattack')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002394791865')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

# This Channel Is For /batch command file store.
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', 'https://t.me/PLAYZ_DATABASE')).split()]  # For Multiple Id Use One Space Between Each.
